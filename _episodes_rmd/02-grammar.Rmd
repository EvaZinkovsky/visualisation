---
title: "Grammar of Visualisations"
keypoints:
- "Map data to aesthetics"
- "Use display attributes such as colour or size to understand data better"
objectives:
- "Understanding the grammar of a data visualisation in R"
questions: "How do we visualise data?"
source: Rmd
teaching: 50
exercises: 20
---
...
## The Grammar of Visualisations in R
