...
# Instead, please edit 02-grammar.md in _episodes_rmd/
title: "Grammar of Visualisations"
keypoints:
- "Common components for creating visualisations"
...
~~~
Error in agridat::harris.wateruse %>% group_by(species, day) %>% summarise(mean_water_use = mean(water)) %>% : could not find function "%>%"
~~~
{: .error}
...
~~~
Error in eval(expr, envir, enclos): object 'base_geom' not found
~~~
{: .error}
...
~~~
Error in ggplot(diamonds, aes(carat, price)): could not find function "ggplot"
~~~
{: .error}
...
~~~
Error in ggplot(diamonds, aes(log10(carat), log10(price))): could not find function "ggplot"
~~~
{: .error}
...
~~~
Error in mtcars %>% ggplot(aes(x = wt, y = mpg)): could not find function "%>%"
~~~
{: .error}
...
~~~
Error in tibble(x = seq(-80, 80, 10), y = seq(-80, 80, 10)) %>% expand(x, : could not find function "%>%"
~~~
{: .error}
